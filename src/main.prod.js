 ...
 */
var customUtils = __webpack_require__(13);
...
var BinarySearchTree = __webpack_require__(25).AVLTree
...
var _pool = __webpack_require__(74);

var _pool2 = _interopRequireDefault(_pool);

var _worker = __webpack_require__(78);
...
var _nedb = __webpack_require__(64);
...
var _recursiveReaddir = __webpack_require__(70);
...
const threads = __webpack_require__(19);


let spawn = threads.spawn;
threads.config.set({
    basepath: {
        node: _path2.default.join(__dirname, "/main-process")
    }
});

class GetMangaList {
    constructor() {
        console.log("--dirname", _path2.default.join(__dirname, "/main-process/"));

        this.db = new _nedb2.default({
            filename: _path2.default.join(_electron.app.getAppPath(), "manga.db"),
            autoload: true
        });
    ...
    initializeGetSubFolder() {
        _electron.ipcMain.on('get-subfolders', function (event, rootFolder) {

            _fs2.default.readdir(rootFolder, {}, function (err, files) {
                if (err) {
                ...
                let folders = files.map(function (folderName) {
                    let folderPath = _path2.default.resolve(rootFolder, folderName);
                    let stat = _fs2.default.lstatSync(folderPath);
                    if (stat.isDirectory()) {
                        return {
                            folderName,
                            folderPath
                ...
                folders = _lodash2.default.filter(folders, function (folder) {
                    return !!folder;
                });
    ...
    initializeGetMangaList() {
        ...
        let self = this;
        _electron.ipcMain.on('get-manga-list', function (event, data) {
            if (processing) {
                return;
            }
            processing = true;
            ...
            self.getFiles(rootFolder, searchValue, isRecursive).then(self.getMangas).then(function (mangas) {
                mangas = _lodash2.default.sortBy(mangas, 'titleShort');
    ...
    initializeGetFavoritesList() {
        let processing = false;
        let self = this;
        _electron.ipcMain.on('get-favorites-list', function (event, folderPaths) {
            if (processing) {
                return;
            }
            processing = true;
        ...
        _electron.ipcMain.on('get-manga', function (event, folderPath) {
    ...
    initializeGetPages() {
        _electron.ipcMain.on('get-pages', function (event, input) {
    ...
    getFiles(rootFolder, searchValue, isRecursive) {
        ...
        function isNotSearched(file, stats) {
            let filePath = _path2.default.basename(file).toLowerCase();
            let isNotSearched = stats.isFile() && filePath.indexOf(searchValue) < 0;
            let zipRegex = /(\.zip$)/ig;
            let isNotSupportedFileFormat = stats.isFile() && !zipRegex.test(_path2.default.extname(file));
        ...
        return new _bluebird2.default(function (resolve, reject) {
            (0, _recursiveReaddir2.default)(rootFolder, ignored, function (err, files) {
                if (err) {
                    console.log(err);
                }
                resolve(files);
    ...
    getMangas(files) {
        let self = this;
        return _bluebird2.default.map(files, function (filePath) {
            return new _bluebird2.default(function (resolve, reject) {
                let mangaTitle = _path2.default.basename(filePath, ".zip");
                self.db.findOne({
                    folderPath: filePath
                }, function (err, manga) {
                    if (!manga) {
    ...
    parseInfo(manga) {
        ...
        //parse event
        let event = _lodash2.default.first(title.match(/^\(.*?\)/g));
        manga.event = event;

        //parse circle
        title = title.replace(event, "").trim();
        let circle = _lodash2.default.first(title.match(/^\[.*?\]/g));
        manga.circle = circle;

        //parse language & translator - Limitation only english language for now
        title = title.replace(circle, "").trim();
        let languageAndScanlator = _lodash2.default.first(title.match(/[\[\(]eng.*/gi)) || "";
        ...
        //parse language
        let language = _lodash2.default.first(languageAndScanlator.match(/[\[\(]Eng.*?[\]\)]/g));
        manga.language = language;

        //parse resolution
        let scanlatorAndResolution = languageAndScanlator.replace(language, "").trim();
        let resolution = _lodash2.default.first(scanlatorAndResolution.match(/[-][0-9]+[x]/g));
...
class SelectDirectory {
    ...
    initializeEvents(mainWindow) {
        _electron.ipcMain.on('select-directory', function (event) {
...
exports.default = SelectDirectory;
module.exports = exports['default'];
...
var _getMangalist = __webpack_require__(20);

var _getMangalist2 = _interopRequireDefault(_getMangalist);

var _selectDirectory = __webpack_require__(21);

var _selectDirectory2 = _interopRequireDefault(_selectDirectory);
...
function createWindow() {
    let getMangaList = new _getMangalist2.default();
    let selectDirectory = new _selectDirectory2.default();
    ...
    var dir = _electron.app.getAppPath() + '/images';
...
module.exports.BinarySearchTree = __webpack_require__(12);
module.exports.AVLTree = __webpack_require__(26);
 ...
 */
var BinarySearchTree = __webpack_require__(12)
  , customUtils = __webpack_require__(13)
  , util = __webpack_require__(9)
  , _ = __webpack_require__(5)
  ;
...
var bluebird = __webpack_require__(44)();
...
var errorObj = util.errorObj;
var catchFilter = __webpack_require__(14)(NEXT_FILTER);
...
var APPLY = {};
var NEXT_FILTER = {};
var tryConvertToPromise = __webpack_require__(55)(Promise, INTERNAL);
var PromiseArray =
...
var PassThroughHandlerContext =
    __webpack_require__(38)(Promise, tryConvertToPromise, NEXT_FILTER);
var catchFilter = __webpack_require__(14)(NEXT_FILTER);
...
__webpack_require__(42)(Promise, INTERNAL, tryConvertToPromise, apiRejection,
    debug);
...
__webpack_require__(56)(Promise, INTERNAL, debug);
...
__webpack_require__(47)(Promise, PromiseArray, tryConvertToPromise, apiRejection);
__webpack_require__(49)(Promise, INTERNAL, tryConvertToPromise, apiRejection);
__webpack_require__(50)(Promise, PromiseArray, apiRejection, tryConvertToPromise, INTERNAL, debug);
__webpack_require__(52)(Promise, PromiseArray, debug);
__webpack_require__(53)(Promise, PromiseArray, apiRejection);
...
var Datastore = __webpack_require__(66);
...
var customUtils = __webpack_require__(16)
  , model = __webpack_require__(8)
  , async = __webpack_require__(6)
  , Executor = __webpack_require__(67)
  , Index = __webpack_require__(17)
  , util = __webpack_require__(9)
  , _ = __webpack_require__(5)
  , Persistence = __webpack_require__(68)
  , Cursor = __webpack_require__(65)
  ;
...
util.inherits(Datastore, __webpack_require__(83).EventEmitter);
...
var storage = __webpack_require__(69)
  ...
  , model = __webpack_require__(8)
  , async = __webpack_require__(6)
  , customUtils = __webpack_require__(16)
  , Index = __webpack_require__(17)
  ;
...
var _slaveCode = __webpack_require__(76);
...
var _slaveCodeUri = __webpack_require__(75);
...
var _child_process = __webpack_require__(81);
