...
Invoke-RestMethod -Headers @{"Authorization"= "token $env:GH_TOKEN"} -Method GET -Uri https://api.github.com/repos/jmarioste/manga-viewer/releases/latest  -ContentType "json" -OutFile ./docs/scripts/metadata.json
